...
from ui.auth import render_auth, logout as auth_logout   # use centralized logout
...
# Not authenticated → show auth, then stop rendering.
...
with right:
    if st.button("Logout", key="logout_main"):
        # delegate to ui.auth.logout to clear session, set auth_pref, and rerun
        auth_logout()
